...
This is needed for copy-protected engines. After the `uciok` command the engine can tell the GUI that it will check the copy protection now. This is done by `copyprotection checking`.
